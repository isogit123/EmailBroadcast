...
namespace Emails.Migrations
{
    ...
    [Migration("20200926004347_EmailErrorsUpdate")]
    partial class EmailErrorsUpdate
    {
            ...
            modelBuilder.Entity("Emails.Models.SentEmailsFailures", b =>
                {
                    ...
                    b.Property<int>("SentEmailsId")
                        .HasColumnType("integer");

                    b.Property<string>("SentEmailsId1")
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.HasIndex("SentEmailsId1");
